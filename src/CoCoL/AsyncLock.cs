...
namespace CoCoL
{
	...
	public class AsyncSemaphore 
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CoCoL.AsyncSemaphore"/> class.
		/// </summary>
	...
	{ 
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CoCoL.AsyncLock"/> class.
		/// </summary>
		public AsyncLock() 
		{ 
		...
		{ 
			...
			/// <summary>
			/// Initializes a new instance of the <see cref="CoCoL.AsyncLock.Releaser"/> struct.
			/// </summary>
			...
			/// <summary>
			/// Releases all resource used by the <see cref="CoCoL.AsyncLock.Releaser"/> object.
			/// </summary>
			/// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="CoCoL.AsyncLock.Releaser"/>. The
			/// <see cref="Dispose"/> method leaves the <see cref="CoCoL.AsyncLock.Releaser"/> in an unusable state. After
			/// calling <see cref="Dispose"/>, you must release all references to the <see cref="CoCoL.AsyncLock.Releaser"/> so
			/// the garbage collector can reclaim the memory that the <see cref="CoCoL.AsyncLock.Releaser"/> was occupying.</remarks>
			public void Dispose() 
			{ 
				if (m_parent != null)
					lock (m_parent)
